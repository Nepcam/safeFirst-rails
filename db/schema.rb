...
ActiveRecord::Schema.define(version: 2019_02_14_004910) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "hazard_categories", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "hazard_control_methods", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "hazards", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "site_id"
    t.index ["site_id"], name: "index_hazards_on_site_id"
  end
  ...
  create_table "sites", force: :cascade do |t|
    t.string "name"
    t.string "location"
    t.datetime "created_at", default: "2019-02-14 00:56:39", null: false
    t.datetime "updated_at", default: "2019-02-14 00:56:39", null: false
  end
